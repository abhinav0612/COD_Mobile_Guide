...
import com.deathalurer.codmobileguide.Fragments.CustomDialgoFragment;
 ...
 */
public class CustomDetailsAdapter extends RecyclerView.Adapter<CustomDetailsAdapter.CustomViewHolder> {
    private List<Recycler_Item> mList;
    private Fragment fragment;

    public CustomDetailsAdapter(List<Recycler_Item> mList, Fragment context) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CustomDialgoFragment dialgoFragment = new CustomDialgoFragment(item.getName(),item.getImageResId(),item.getDesc());
